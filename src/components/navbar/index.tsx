    ...
    return (
        <div className="grid grid-cols-2 lg:grid-cols-3 p-6 fixed top-0 left-0 right-0 z-50">
            <div className="flex items-center gap-4">
                ...
                {!hasCanvas ||
                    (!hasStyleGuide && (
                        <div className="lg:inline-block hidden rounded-full text-primary/60 border Oborder-white/ [0.12] backdrop-blur-xl Obg-white/ [0.08] px-4 py-2 text-sm saturate-150">
            ...
            <div className="lg:flex hidden items-center justify-center gap-2">
                <div className="flex items-center gap-2 backdrop-blur-xl Obg-white/[0.08] border Oborder-white/[0.12] rounded-full p-2 saturate-150">
                    {tabs.map((t) => (
                        <Link
                            key={t.href}
                            href={t.href}
                            className={[
                                ...
                                `${pathname}?project=${projectId}` === t.href ? 'bg-white/[0.12] text-white border border-white/[0.16] backdrop-blur-sm' : 'text-zinc-400 border border-transparent hover:bg-white/[0.06] hover:text-zinc-200'
                            ].join(' ')}>
                            <span
                                className={
